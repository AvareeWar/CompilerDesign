				...
				)
{
  ...
  // YOUR CODE HERE
  		...
  		switch (tokenizer.peek()){
        case TROUSERS_KEYWORD_SYM:
      
        case SHIRTS_KEYWORD_SYM:
        
        case UNDERWEAR_KEYWORD_SYM:
        
        case SHEETS_KEYWORD_SYM:
            delete(tokenizer.advance());
            break;
				...
				)
{
  ...
  // YOUR CODE HERE
		switch(tokenizer.peek()){
				case HOT_KEYWORD_SYM:
				
        case WARM_KEYWORD_SYM:
        
        case COLD_KEYWORD_SYM:
            break;
				...
				)
{
  ...
  // YOUR CODE HERE
		...
		switch(tokenizer.peek()){
				case LIGHTS_KEYWORD_SYM:
				
        case DARKS_KEYWORD_SYM:
        
        case DELICATES_KEYWORD_SYM:
            break;
				...
				)
{
  ...
  switch(tokenizer.peek()){
        ...
        default:
            throw "Expected \"machine wash or \"hand wash\"";
    }
