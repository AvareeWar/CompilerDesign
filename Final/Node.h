...
public :
  ...
  VariableMention*
		compile		(simpleType_ty&	simpleType
				)
				{
				  ...
				  // //    BOOLEAN_ST.
				  // if (!(lhsType == BOOLEAN_ST && rhsType == BOOLEAN_ST)){
				  // 	throw ("Error");
				  // }
				  ...
				  // //  Return 'lhsVarPtr_'
				  // simpleType = BOOLEAN_ST;
				  // return(lhsVarPtr_);	// <-- Change that 'NULL'
				}
  ...
  void		writeAssembly	(std::ostream&	output
				)
				{
				  ...
				  // output << *lhsVarPtr_ << "," << *rhsVarPtr_ 
					 //<< binaryLogicOpName[getBinaryLogicOp()] 
					 //<< std::endl;
				}
...
public :
  ...
  VariableMention*
		compile		(simpleType_ty&	simpleType
				)
				{
				  ...
				  //	'INT_DIVIDE_BMO'
				  if (lhsType_ == INTEGER_ST && rhsType_ == INTEGER_ST){
				  ...
				  else if (lhsType_ == REAL_ST && rhsType_ == REAL_ST){
  ...
  void		writeAssembly	(std::ostream&	output
				)
				{
				  ...
				  if (lhsType_ == INTEGER_ST && rhsType_ == REAL_ST){
				  ...
				  else if (lhsType_ == REAL_ST && rhsType_ == INTEGER_ST) {
